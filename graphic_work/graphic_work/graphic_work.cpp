// graphic_work.cpp : Определяет точку входа для приложения.
//
#include "framework.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_GRAPHICWORK, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_GRAPHICWORK));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_GRAPHICWORK));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_GRAPHICWORK);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_CREATE:
        SetWindowCoords(hWnd);
        fd.InitDlg(hWnd, hInst);

        fc = SingleFunctionContainer::GetInstance();

        hDC = GetDC(hWnd); // получаем контекст устройства нашего окна
        drawer.SetWindowPixelFormat(hDC); // устанавливаем параметры контекста воспроизведения OpenGL
...
void SetWindowCoords(HWND hWnd)
{
    POINT screenSize;
